from src.features.rag.application.metadata import clean_optional, detect_language, extract_hierarchy, normalize_text, parse_filename_metadata
...
def test_known_book_opening_is_resilient_to_parser_noise_before_title():
    ...
    from src.features.rag.application.document_metadata import extract_document_metadata
